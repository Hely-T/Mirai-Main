module.exports.config = {
	...
	usages: "gif bomman,mixi,cat,dog,rainbow,mixi",
	cooldowns: 1,
...
module.exports.run = async({api,event,args,client,Users,Threads,__GLOBAL,Currencies}) => {
	...
	var { threadID, messageID } = event
	 if (args.length == 0){ return api.sendMessage(`/Bạn có thể sử dụng:\n /yt audio [link youtube]=> nó sẽ tải âm thanh của link đó !\n\n/yt video [link youtube]=> nó sẽ tải video của link đó !\n\n/yts [em có nghe]=> nó sẽ gr 3 kết quả có liên quan vs từ khoá\n\nGiới hạn độ dài cho phép là 8 phút.`, event.threadID, event.messageID);
  };
